...
def sorted_test_src_views_fixed(cam2worlds_dict, test_views, train_views):
    ...
    print('train_views is ',train_views)

    print('IMO',cam2worlds_dict.keys())
...
def main(args):
    ...
    test_views = [30, 24, 23, 37]
    train_views = [i for i in range(38) if i not in test_views]
    ...
    for torch_file in tqdm(sorted(glob(os.path.join(data_dir, "*.torch")))):
        ...
        for scene_data in scene_datas:
            ...
            #print('cam2worlds_dict is ',cam2worlds_dict)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_contexts", type=int,
                        default=3, help="output directory")
