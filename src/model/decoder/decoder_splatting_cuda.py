...
class DecoderSplattingCUDA(Decoder[DecoderSplattingCUDACfg]):
    ...
    def forward(
        ...
        # d2n_normal: depth 2 normal
        color,depth,d2n_normal,normal,dist = render_cuda(
        ...
        # print('depth max 3',depth.max())
        # print('depth mean 3',depth.mean())
        color = rearrange(color, "(b v) c h w -> b v c h w", b=b, v=v)
        depth = rearrange(depth, "(b v) h w -> b v h w", b=b, v=v)
        normal = rearrange(normal, "(b v) c h w -> b v c h w", b=b, v=v)
        d2n = rearrange(d2n_normal, "(b v) c h w -> b v c h w", b=b, v=v)
